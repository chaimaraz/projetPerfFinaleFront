...
formateurs: Formateur[]=[];
  ...
  createCycle(){
    this.cycleService.addCycle(this.cycle).subscribe(
      Response =>console.log("ajouter ")
      );
      this.router.navigate(['/cycles']);
  }
modifierCycle(){
  this.cycleService.updateCycle(this.cycle)
...
comparerFormateur(o1:Formateur, o2:Formateur):boolean{
  ...
  return o1===null || o2===null || o1===undefined|| o2===undefined ? false :o1.idFormateur==o2.idFormateur;

}

  ngOnInit(): void {
    this.cycleService.getformateurs()
